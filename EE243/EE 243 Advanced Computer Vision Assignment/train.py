...
less = np.ones(100)
test_accuracy = np.convolve(less/less.sum(), test_accuracy, mode = 'valid')
figure1 = plt.plot(np.arange(len(test_accuracy)), test_accuracy, '-r')
...
train_accuracy = np.convolve(less/less.sum(), train_accuracy, mode = 'valid')
figure2 = plt.plot(np.arange(len(train_accuracy)), train_accuracy, '-b')
plt.xlabel('Number of Iterations')
plt.ylabel('Train Accuracy')
plt.title('Train Accuracy of CNN Model')
plt.grid(True)
plt.savefig('Train Accuracy.png')
plt.show(True)

train_loss = np.convolve(less/less.sum(), train_loss, mode = 'valid')
figure3 = plt.plot(np.arange(len(train_loss)), train_loss, '-g')
plt.xlabel('Number of Iterations')
plt.ylabel('Train Loss')
plt.title('Train Loss of CNN Model')
plt.grid(True)
